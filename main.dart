...
void main() {
  ...
  WidgetsBinding.instance.addPostFrameCallback((_) {
    setWindowMinSize(Size(600, 710)); // 设置最小窗口大小
    setWindowMaxSize(Size(700, 810)); // 设置最大窗口大小
  });
}
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(home: const BoardPage(title: 'Reversi Board'));
  }
}
                ...
                onTap: () {
                  setState(() {
                    ...
                    // 检查点击的点是否在可落子位置中
                      ...
                      (point) => point.y == index % 8 && point.x == index ~/ 8,
                    )) {
                      _board = makeMove(
                        _currentPlayer % 2 + 1,
                        _board,
